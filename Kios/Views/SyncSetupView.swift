...
/// Sync credentials form. Drives both the first-run flow (shown alone when
/// `AppEnvironment.sync == nil`) and the in-app "Sync protocol" / "Sync URL"
/// detail screen pushed from the editorial Settings page.
